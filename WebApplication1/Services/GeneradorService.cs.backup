    ...
    public class GeneradorService
    {
        ...
        private async Task GenerarContenidoCierreCiclosAsync(SqlConnection sql, StringBuilder contenido, long visitadorId, int ano, int ciclo)
        {
            ...
            string query = @"SELECT * FROM [MD_CierreCiclo] 
                             WHERE (ZONA = @visitadorId AND (NU_ANO = @ano - 1 AND CICLO >= @ciclo)) 
                                OR (ZONA = @visitadorId AND NU_ANO = @ano)  
...
CREATE TABLE ""puntos"" (""ID_Punto"" INTEGER(11), ""ID_Visitador"" INTEGER(11), ""NU_Puntos"" INTEGER(11), ""FE_Fecha"" TEXT(10), ""TX_Concepto"" TEXT(255));
...
CREATE TABLE ""usuario"" (""ID_Usuario"" INTEGER(11), ""TX_Usuario"" TEXT(50), ""TX_Password"" TEXT(100), ""BO_Activo"" INTEGER(11));
